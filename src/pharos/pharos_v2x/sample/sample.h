...
#define OBU_RECEIVE_BUFFER_SIZE 1500 // Max size that TCP can handle in one frame
#define MAX_UPER_SIZE 1400 // Max size that UPER can have other than header

#define PVD_INTERVAL 200 //msec (1s->0.2s) [CHECK] Mail: PVD_Transfer_Period
#define BSM_INTERVAL 100 //msec (0.1s) [CHECK] BSM_Transfer_Period --> Do not need!
