...
class RosGpsEkf:
    ...
    def ekf_reset(self):
        ...
        self.R = np.mat(np.diag([5.0, 5.0, 50, 10.0]))
    ...
    def bicycle_model(self, x, y, theta, z, vel, alpha, dt):
        ...
        # theta = theta + beta
        print(dt, beta, self.yaw_rate*dt)
...
if __name__ == '__main__':
    ...
    gps_odom = rospy.get_param('~gps_odom_topic', '/odom/mcl')
    ...
    rospy.Subscriber('/xsens/imu/data', Imu, gps_ekf.rpy_rate_callback, queue_size=1)
